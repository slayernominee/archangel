...
print('If you want to use https: You need a domain, and matching a & aaaa records for you ipv4&6.')
print('Then Install Certbot - Run sudo certbot --nginx | and follow the wizard')
