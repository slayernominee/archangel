...
'''
CREATE TABLE user (id integer, mail text, username text, name text, password text, birthday integer, location text, discord text, description text, website text, image text, banner text, verification text, twofa text, genres text, flairs text, favorites text, language text, theme text, verify text);
